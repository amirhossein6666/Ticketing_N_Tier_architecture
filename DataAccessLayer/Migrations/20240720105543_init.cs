...
namespace Ticketing.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SupporterRatings",
                columns: table => new
                {
                    SupporterId = table.Column<int>(type: "int", nullable: false),
                    RatedUserId = table.Column<int>(type: "int", nullable: false),
                    RelatedTicketId = table.Column<int>(type: "int", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupporterRatings", x => new { x.RatedUserId, x.RelatedTicketId, x.SupporterId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_SupporterRatings_Users_SupporterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupporterRatings_SupporterId",
                table: "SupporterRatings",
                column: "SupporterId");
