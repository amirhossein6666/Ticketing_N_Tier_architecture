...
namespace Ticketing.DataAccessLayer.Migrations
{
    ...
    [Migration("20240731104306_navab")]
    partial class navab
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    b.Property<int>("AnsweredTicketId")
                        .HasColumnType("int");

                    b.Property<int>("SupportersId")
                        .HasColumnType("int");

                    b.HasKey("AnsweredTicketId", "SupportersId");
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    b.HasOne("Ticketing.DataAccessLayer.Entities.Ticket", null)
                        .WithMany()
                        .HasForeignKey("AnsweredTicketId")
